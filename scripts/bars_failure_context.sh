...
echo "BARS_BATCH_INTERVAL_SEC=2 daily / 5 backfill (sleep between batches)"
echo "Daily sync: forward-only; 250-day lookback via backfill_bars (or BARS_DAILY_LOOKBACK=1)"
echo "GF poll: fast <=14d, med <=90d, slow >90d (see bars_sheets._poll_timing_for_jobs)"
