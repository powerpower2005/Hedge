export default {
  ...
  guide: {
    ...
    s2Title: "새 픽 제출",
    s2Body:
      "로그인한 상태에서 상단의 새 픽 버튼을 누르면 등록 양식으로 이동합니다. 티커, 국가·시장, 목표 수익률(%), 기간(일)을 입력합니다. 선택 **추가 메모**는 있을 때만 픽 상세에서 접어 두었다가 볼 수 있으며, 시세·판정에는 쓰이지 않습니다. 미국은 NASDAQ·NYSE·NYSEARCA·NYSEAMERICAN, 한국은 KRX·KOSPI·KOSDAQ 중 맞는 시장을 고르고 국가와 짝이 맞아야 합니다(한국 행은 시트에서 모두 KRX: 접두로 조회). 티커는 영문·숫자만 사용합니다. 등록이 안 되면 Google Finance(https://www.google.com/finance/)에서 거래소 접두와 티커가 맞는지 확인해 보세요. 제출 후 자동 검사가 돌고, 통과하면 진행 중 목록에 나타납니다.",
    s3Title: "규칙과 한도",
    s3Body:
